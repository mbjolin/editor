 ...
 */
@Testcontainers
public class Cas05bTest extends SimulateUserInterfaceInteraction {

  @Test
  public void executeSessionModifyModelWithAnErrorTest() throws IOException {
    // GIVEN
    ...
    InputStream is2 = getClass().getClassLoader()
        .getResourceAsStream("cas05/description_3.txt");
    ...
    Assertions.assertTrue(content.getSystemJ().getMessagesAsString().contains("Il y a une erreur de logique dans"));
  }
